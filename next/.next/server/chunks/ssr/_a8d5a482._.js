...
async function RenderNews({ lang, dictionary }) {
    const pageData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$strapi$2f$get$2d$strapi$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getStrapiData"])('en', '/api/news?populate[0]=banner&populate[1]=authorImage&populate[3]=localizations&pagination[pageSize]=100', [
        'news-single'
    ]);
    /* eslint-disable */ // ... diğer importlar ve kodlar
    console.log('Contact sayfası render edildi!', pageData);
    // ... diğer kodlar
    /* eslint-enable */ const newsLocaleFlipped = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$strapi$2f$flip$2d$locale$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["flipNewsLocale"])(lang, pageData.data);
...
//# sourceMappingURL=_a8d5a482._.js.map